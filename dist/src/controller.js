...
const waterph_1 = require("./models/waterph");
var countries;
(function (countries) {
    countries["NG"] = "NG";
    countries["ZA"] = "ZA";
...
async function handlePredict(req, res) {
    ...
    try {
        return await (0, predictionService_1.makePrediction)(temperature, humidity, ph, waterAvailability, crop_1.CROPS[crop]).then((harvest) => {
